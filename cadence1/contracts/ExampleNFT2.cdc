...
access(all) contract ExampleNFT2: NonFungibleToken {
        ...
        access(all) fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return ExampleNFT2.resolveContractView(resourceType: Type<@ExampleNFT2.NFT>(), viewType: Type<MetadataViews.NFTCollectionData>())
                case Type<MetadataViews.NFTCollectionDisplay>():
                    return ExampleNFT2.resolveContractView(resourceType: Type<@ExampleNFT2.NFT>(), viewType: Type<MetadataViews.NFTCollectionDisplay>())
                ...
                case Type<MetadataViews.EVMBridgedMetadata>():
                    ...
                    let contractLevel = ExampleNFT2.resolveContractView(
                            resourceType: nil,
    ...
    access(all) resource Collection: NonFungibleToken.Collection, ExampleNFTCollectionPublic {
        ...
        access(all) view fun getSupportedNFTTypes(): {Type: Bool} {
            ...
            supportedTypes[Type<@ExampleNFT2.NFT>()] = true
        ...
        access(all) fun deposit(token: @{NonFungibleToken.NFT}) {
            ...
            ExampleNFT2.emitNFTUpdated(authTokenRef)
        }
    ...
    init() {
        ...
        let collectionCap = self.account.capabilities.storage.issue<&ExampleNFT2.Collection>(self.CollectionStoragePath)
