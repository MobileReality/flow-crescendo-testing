 ...
 * */
export const getExampleNFTCollectionLength = async (account, direct = false) =>
    willResolve(
        executeScript(isArray(account)?{
            name: 'exampleNFT/read_collection_lengths',
            args: [[account, Array(Address)]],
        }:{
            name: direct?'exampleNFT/read_collection_length_direct':'exampleNFT/read_collection_length',
